...
describe('replaceWithDomainName', function () {
    ...
    describe('In Stock Page', function () {
        ...
        var payload = {
            "pageType": "product",
            "url": "https://www.petshopusa.com/petflfl10829.html",
            "html": cache.load("https://www.petshopusa.com/petflfl10829.html")
        }
        ...
        it('should be true when product is in stock', function (done) {
            ...
            Structure(payload, function (err, inStockPage) {
                var expected = JSON.stringify({
                    "name": "CIPRO 001TL-CIPRO-30-500 Fish Flox Forte 500 mg",
                    "price": "43.19",
                    "url": payload.url,
                    "inStock": true,
                    "stockLevel": null,
                    "image": "https://www.petshopusa.com/assets/img/topbar_brands/unbeatable.png",
                    "country": 'us'
                })
    ...
    describe('Search Page', function () {
        ...
        var payload = {
            "pageType": "search",
            "url": "https://www.petshopusa.com/Animal-Care--and--Medication/smanmed10.html",
            "html": cache.load("https://www.petshopusa.com/Animal-Care--and--Medication/smanmed10.html")
        }
