...
var Product = {
    name: function($) {
        var name = $('div.product-name').html();
        name = cleanName(name);
        return name;
...
var Search = {
    container: function($) {
        var searchProducts = $('li.aduk-clgo-prodlist')
    ...
    price: function($, product) {
        var price = $(product).find('span.regular-price').text();
        price = getPrice(price);
        return price;
    },
...
var Pagination = {
    ...
    items: function($) {
        var items = $('li.aduk-clgo-prodlist')
