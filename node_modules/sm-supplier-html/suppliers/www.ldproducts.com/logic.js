...
var Product = {
    name: function($) {
        var name = $('.product_info h1').text();
        name = cleanName(name);
        return name;
    },
    inStock: function($) {
        var chcek=$('.status').text()
        var inStock =true
        inStock=instockCheck(chcek,inStock)
        return inStock
},
    price: function($) {
        var price = $('.special-price').text();
    ...
    description: function($) {
        var description = $('p.ldp-short-description').text();
...
var Search = {
    ...
    price: function($, product) {
        var price = $(product).find('.special-price>span.price').html();
        price = getPrice(price);
        return price;
    },
