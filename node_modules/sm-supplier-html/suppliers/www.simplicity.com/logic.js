...
return 'unchecked'
    ...
    description: function($) {
        var description = $('div.product-long-description').text().replace(/(\r\n|\n|\r)/gm," ").trim();;
...
var Pagination = {
     ...
     items: function($) {
        ...
        var items = $('a.pagination-anchor.active-paging').last().text();
     ...
     pages: function($) {
        ...
        var products = $('div.results-hits').last().text().replace(',', '');
