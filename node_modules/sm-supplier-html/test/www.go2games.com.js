...
describe('www.go2games.com', function() {

    describe('In Stock Page', function() {

        var payload = {
            "pageType" : "product",
            "url" : "https://www.go2games.com/ps4/marvel-s-spider-man-ps4",
            "html": cache.load("https://www.go2games.com/ps4/marvel-s-spider-man-ps4")
        }
    ...
    describe('Search page category', function() {
        ...
        var payload = {
            "pageType" : "category",
            "url" : "http://www.go2games.com/sale?p=1#b",
            "html": cache.load("http://www.go2games.com/sale?p=1#b")
        }
    ...
    describe('Out of Stock Page', function() {
        ...
        var payload = {
            "pageType" : "product",
            "url" : "http://www.go2games.com/deus-ex-mankind-divided-ps4",
            "html": cache.load("http://www.go2games.com/deus-ex-mankind-divided-ps4")
        }
        ...
        it('should be false when product is in store only', function (done) {
            ...
            Structure(payload, function(err, inStockPage) {
                var expected = JSON.stringify({
                    "name": "Deus Ex: Mankind Divided (PS4)",
                    "price": "54.99",
                    "url": "http://www.go2games.com/deus-ex-mankind-divided-ps4",
                    "inStock": false,
                    "stockLevel": null,
                    "image": 'http://www.go2games.com/media/catalog/product/cache/1/image/400x347.82608695652/9df78eab33525d08d6e5fb8d27136e95/C/E/CEA0D95CAAB0302B84A7A0CF70BACA4B.jpg',
                    "country": 'uk'
                })
    ...
    describe('Search Page', function() {
        ...
        var payload = {
            "pageType" : "search",
            "url" : "https://www.go2games.com/xbox-one?p=3",
            "html": cache.load("https://www.go2games.com/xbox-one?p=3")
        }
