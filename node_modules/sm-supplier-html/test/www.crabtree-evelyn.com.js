...
describe('replaceWithDomainName', function () {
    ...
    describe('In Stock Page', function () {
        ...
        var payload = {
            "pageType": "product",
            "url": "http://www.crabtree-evelyn.com/body-care/lotions-creams/pear-pink-magnolia-uplifting-body-souffl%C3%A9/897870.html?cgid=bath-body-body-care-lotions-creams#start=1",
            "html": cache.load("http://www.crabtree-evelyn.com/body-care/lotions-creams/pear-pink-magnolia-uplifting-body-souffl%C3%A9/897870.html?cgid=bath-body-body-care-lotions-creams#start=1")
        }
    ...
    describe('Search page category', function() {
        ...
        var payload = {
            "pageType" : "category",
            "url" : "http://www.crabtree-evelyn.com/hand-care/",
            "html": cache.load("http://www.crabtree-evelyn.com/hand-care/")
        }
