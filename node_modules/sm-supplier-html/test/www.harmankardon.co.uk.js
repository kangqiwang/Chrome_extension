...
describe('replaceWithDomainName', function () {
    ...
    describe('In Stock Page', function () {
        ...
        var payload = {
            "pageType": "product",
            "url": "https://www.harmankardon.co.uk/home-theatre-systems/HKTS+16.html?dwvar_HKTS%2016_color=Black%20Lacquer-EMEA-Current&cgid=home-theater-systems#start=1",
            "html": cache.load("https://www.harmankardon.co.uk/home-theatre-systems/HKTS+16.html?dwvar_HKTS%2016_color=Black%20Lacquer-EMEA-Current&cgid=home-theater-systems#start=1")
        }
    ...
    describe('Search page category', function() {
        ...
        var payload = {
            "pageType" : "category",
            "url" : "https://www.harmankardon.co.uk/wireless-speakers/",
            "html": cache.load("https://www.harmankardon.co.uk/wireless-speakers/")
        }
