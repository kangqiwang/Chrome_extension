...
describe('replaceWithwebAddress', function() {
    ...
    describe('In Stock Page', function() {
        ...
        var payload = {
            "pageType" : "product",
            "url" : "https://www.westmarine.com/buy/engel--30-oz-stainless-steel-tumbler--17266107?recordNum=1",
            "html": cache.load("https://www.westmarine.com/buy/engel--30-oz-stainless-steel-tumbler--17266107?recordNum=1")
        }
    ...
    describe('Search page pagination', function() {
        ...
        var payload = {
            "pageType" : "pagination",
            "url" : "https://www.westmarine.com/boat-cabin-galley",
            "html": cache.load("https://www.westmarine.com/boat-cabin-galley")

        }

        it('should be true when number of items and pages correct', function (done) {

            Structure(payload, function(error,pagination) {
                var expected = JSON.stringify({
                    "items": 30,
                    "pages": 55,
                    "url": 'https://www.westmarine.com/boat-cabin-galley'
    ...
    describe('Search page category', function() {
        ...
        var payload = {
            "pageType" : "category",
            "url" : "http://www.westmarine.com/boat-cabin-galley",
            "html": cache.load("http://www.westmarine.com/boat-cabin-galley")

        }

        it('should be true when number of items and pages correct', function (done) {

            Structure(payload, function(error,category) {
                var expected = JSON.stringify({
                    "name": "Boat Cabin & Galley",
                    "url":'http://www.westmarine.com/boat-cabin-galley'
                })
    ...
    describe('Search Page', function() {
        ...
        var payload = {
            "pageType" : "search",
            "url" : "https://www.westmarine.com/rigid-boats",
            "html": cache.load("https://www.westmarine.com/rigid-boats")
        }
