...
describe('replaceWithwebAddress', function() {
    ...
    describe('In Stock Page', function() {
        ...
        var payload = {
            "pageType" : "product",
            "url" : "https://www.costco.co.uk/Computers/Laptops-MacBooks/Microsoft-Surface-Book-2-Intel-Core-i7-16GB-RAM-1TB-Solid-State-Drive-135-Convertible-Notebook-in-Silver/p/269655",
            "html" : cache.load("https://www.costco.co.uk/Computers/Laptops-MacBooks/Microsoft-Surface-Book-2-Intel-Core-i7-16GB-RAM-1TB-Solid-State-Drive-135-Convertible-Notebook-in-Silver/p/269655")
        }
    ...
    describe('Search page category', function() {
        ...
        var payload = {
            "pageType" : "category",
            "url" : "https://www.costco.co.uk/Computers/Laptops-MacBooks/c/cos_16.1",
            "html" : cache.load("https://www.costco.co.uk/Computers/Laptops-MacBooks/c/cos_16.1")
        }
        ...
        it('should be true when number of items and pages correct', function (done) {
            ...
            Structure(payload, function(err, category) {
                var expected = JSON.stringify({
                    "name": "Toys",
                    "url":"http://www.costco.co.uk/view/c/toys-baby-child/toys/all-toys"
                })
        ...
        it('should be true when number of items and pages correct', function (done) {
            ...
            Structure(payload, function(err, pagination) {
                var expected = JSON.stringify({
                    "items": 99,
                    "pages": 3,
                    "url":"http://www.costco.co.uk/view/c/home-garden/furniture"
                })
        ...
        it('should return null items and pages', function (done) {
            ...
            Structure(payload, function(err, pagination) {
                var expected = JSON.stringify({
                    "items": null,
                    "pages": null,
                    "url":"http://www.costco.co.uk/view/p/nicoletti-darwin-italian-top-grain-leather-corner-sofa-with-adjustable-seat-depth-right-facing-228480"
                })
                JSON.stringify(pagination).should.equal(expected);
                done()
            })
