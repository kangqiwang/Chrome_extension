...
describe('replaceWithDomainName', function () {
    ...
    describe('In Stock Page', function () {
        ...
        var payload = {
            "pageType": "product",
            "url": "http://www.boyes.co.uk/health-and-beauty/caress-3-pack-bath-sponge.html",
            "html": cache.load("http://www.boyes.co.uk/health-and-beauty/caress-3-pack-bath-sponge.html")
        }
    ...
    describe('Search page category', function() {
        ...
        var payload = {
            "pageType" : "category",
            "url" : "http://www.boyes.co.uk/health-and-beauty.html",
            "html": cache.load("http://www.boyes.co.uk/health-and-beauty.html")
        }
