...
var Search = {
    container: function($) {
        var product = $('div.prod');

        return product;
    },
    name: function($, product) {
        var name = $(product).find('div.prdTtl').text();
        name = cleanName(name);

        return name;
    },
    price: function($, product) {
        var price = $(product).find('div.prdPrc strong').text();
        price = getPrice(price);
...
var Pagination = {
     ...
     items: function($) {
         var items = $('span#searchspring-last_item').text();
     ...
     pages: function($) {
         ...
         var products = $('span#searchspring-total_items').text();
