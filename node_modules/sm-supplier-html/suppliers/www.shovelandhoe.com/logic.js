...
var Product = {
    ...
    inStock: function($) {
        var inStock = true
        var stockcheck = $('div[itemprop=offers]').text();
...
var Search = {
    container: function($) {
        var seachProducts = $('div.v-product');
        return seachProducts;
    },
    ...
    price: function($, product) {
        var price = $(product).find('div.product_productprice').html();
        price = getPrice(price);
        return price;
    },
    url: function($, product) {
        var url = $(product).find('div.v-product__details a').attr('href');
        return url
    },
    image: function($, product) {
        var image = $(product).find('a.v-product__img img').attr('src')        
        image = 'https:' + image
        return image
    }
}
