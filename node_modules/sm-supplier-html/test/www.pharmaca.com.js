...
describe('www.pharmaca.com', function() {    

    describe('In Stock Page', function() {

        var payload = {     
            "pageType" : "product",
            "url" : "https://www.pharmaca.com/natural-stacks-acetylcholine-brain-food-60-vcaps",
            "html": cache.load("https://www.pharmaca.com/natural-stacks-acetylcholine-brain-food-60-vcaps")
        }
        ...
        it('should be true when product is in stock', function () {
           ...
           inStockPage.name.should.be.equal("Black Diamond HeavyWeight Waterproof Gloves");
           ...
           inStockPage.inStock.should.be.equal(true);
           inStockPage.image.should.be.equal('https://s1.thcdn.com/productimg/1600/1600/11580543-1104537722369471.jpg');
    ...
    describe('Search page pagination', function() {
        ...
        var payload = {
            "pageType" : "pagination",
            "url" : "https://www.pharmaca.com/beauty/facial-care/moisturizers-oils?SID=djjc7kbi4sjqscpbeap666qeu1",
            "html": cache.load("https://www.pharmaca.com/beauty/facial-care/moisturizers-oils?SID=djjc7kbi4sjqscpbeap666qeu1")
        }
        ...
        it('should be true when number of items and pages correct', function () {
            ...
            var expected = JSON.stringify({
                "items": 7,
                "pages": null,
                "url":"https://www.bitsandpieces.com/category/childrens-puzzles"
            })
