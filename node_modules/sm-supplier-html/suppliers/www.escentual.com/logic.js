...
var Product = {
    ...
    inStock: function($) {
        var check =$('td.a-center').last().text()
        var inStock=true
    ...
    image: function($) {
        var image = $('a.cloud-zoom').attr('href');
        return image;
    },
    url: function ($) {
        return $
...
var Search = {
    container: function($) {
        var searchProducts = $('div.product-wrapper')
    ...
    url: function($, product) {
         var url = null;
        var anchor = $(product).find('a.product-image');
        if(anchor) {
...
var Category = {
    name: function($) {
        var name = $('div.page-title.category-title').text();
        name = cleanName(name);
        return name;
    }
}
