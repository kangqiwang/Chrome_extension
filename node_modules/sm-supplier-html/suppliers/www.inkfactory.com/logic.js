...
var price = function thePrice($) {
    var price = $('.price-including-tax').text()
...
var image = function image($) {
    return $('img#image').attr('src');
}

var Search = {
    container: function($) {
        var searchProducts = $('div.category-products ul.products-grid li.item');
